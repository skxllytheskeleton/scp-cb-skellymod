		...
		If SelectedItem <> Null Then
			Select SelectedItem\itemtemplate\tempname
				...
				Case "scp500"
					...
					;[Block]
					If CanUseItem(False, False, True)	
						Msg = "You drink the soda. You feel an unseen presence in the room with you."
						MsgTimer = 70*7
						PlaySound_Strict LoadTempSound("SFX\SCP\2107\drink.ogg")
					...
					Case "scp1356"
					;[Block]	
					Msg = "You squeak SCP-1356."
					MsgTimer = 70*7
					PlaySound_Strict LoadTempSound("SFX\SCP\1356\squeak.ogg")
					SelectedItem = Null
					;[End Block]
					Case "scp622"
					;[Block]	
					Msg = "You spray a bit of the substance in the air."
					MsgTimer = 70*7
					PlaySound_Strict LoadTempSound("SFX\SCP\622\spray.ogg")
					SelectedItem = Null
					;[End Block]
