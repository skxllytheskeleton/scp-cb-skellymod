...
;			EntityParent dp\cam,fr\Forest_Pivot
		...
		Case "room2testroom2"
			...
			it = CreateItem("Document Your Mother", "paper", r\x - 312.0 * RoomScale, r\y + 264.0 * RoomScale, r\z + 176.0 * RoomScale)
		...
		Case "room2sroom"
			...
			it = CreateItem("SCP-1459-J", "scp1459j", r\x + 1776.0 * RoomScale, r\y + 400.0 * RoomScale, r\z + 427.0 * RoomScale)
			EntityParent(it\collider, r\obj)
		...
		Case "room2poffices2"
			...
			it = CreateItem("SCP-2107", "scp2107", r\x + 920.0*RoomScale, r\y + 125.0*RoomScale, r\z - 439.0*RoomScale)
			EntityParent(it\collider, r\obj)
			
			it = CreateItem("SCP-2107 Animal Testing Proposal", "paper", r\x + 920.0*RoomScale, r\y + 125.0*RoomScale, r\z - 439.0*RoomScale)
			EntityParent(it\collider, r\obj)
			;[End Block]
		Case "room2elevator"
			;[Block]
...
;			PositionEntity(r\Objects[6], r\x - 848*RoomScale, 0.5, r\z-576*RoomScale, True)
		...
		Case "room2scps"
			...
			it = CreateItem("SCP-064", "scp064", r\x - 552.0 * RoomScale, r\y + 220.0 * RoomScale, r\z - 760.0 * RoomScale)
			EntityParent(it\collider, r\obj)
			
			it = CreateItem("SCP-1356", "scp1356", r\x + 552.0 * RoomScale, r\y + 224.0 * RoomScale, r\z - 758.0 * RoomScale)
			EntityParent(it\collider, r\obj)
			
			it = CreateItem("SCP-622", "scp622", r\x + 568.0 * RoomScale, r\y + 178.0 * RoomScale, r\z + 760.0 * RoomScale)
			EntityParent(it\collider, r\obj)
