...
Function InitItemTemplates()
	...
	it = CreateItemTemplate("Document Your Mother", "paper", "GFX\items\paper.x", "GFX\items\INVpaper.jpg", "GFX\items\docurmom.jpg", 0.003) : it\sound = 0
	it = CreateItemTemplate("SCP-2107 Animal Testing Proposal", "paper", "GFX\items\paper.x", "GFX\items\INVpaper.jpg", "GFX\items\2107proposal.jpg", 0.003) : it\sound = 0
	...
	it = CreateItemTemplate("SCP-2107", "scp2107", "GFX\items\scp2107.b3d", "GFX\items\INV2107.jpg", "", 5) : it\sound = 2
	
	it = CreateItemTemplate("SCP-064", "scp064", "GFX\items\064.b3d", "GFX\items\INVscp064.jpg", "", 0.3) : it\sound = 2
	
	it = CreateItemTemplate("SCP-1459-J", "scp1459j", "GFX\items\1459j.b3d", "GFX\items\INV1459j.jpg", "", 0.5) : it\sound = 2
	
	it = CreateItemTemplate("SCP-1356", "scp1356", "GFX\items\scp1356.b3d", "GFX\items\INVscp1356.jpg", "", 0.08) : it\sound = 2
	
	it = CreateItemTemplate("SCP-622", "scp622", "GFX\items\scp622.b3d", "GFX\items\INVscp622.jpg", "", 0.01) : it\sound = 2
